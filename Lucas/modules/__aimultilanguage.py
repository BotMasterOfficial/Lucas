...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("yone", "Aco")
        URL = "https://api.affiliateplus.xyz/api/chatbot?message=hi&botname=@Lucas&ownername=@A_viyu"
        ...
        test = test.replace("yone", "Aco")
        test = test.replace("yone", "Aco")
        URL = f"https://api.affiliateplus.xyz/api/chatbot?message={test}&botname=@Lucas&ownername=@A_viyu"
        try:
            r = requests.request("GET", url=URL)
        except:
            return
