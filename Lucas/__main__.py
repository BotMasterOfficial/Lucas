...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/62a7b5a08e4873d085ef8.jpg), ɪᴍ ʏᴏɴᴇ ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` [lucas🙋‍♀️](https://telegra.ph/file/62a7b5a08e4873d085ef8.jpg) 
    ...
    if query.data == "lucas_":
        query.message.edit_text(
            text=""" ℹ️ I'm *lucas*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://github.com/noob-kittu/Lucas).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *lucas*
                 \nHere is the [Source Code](https://github.com/Noob-kittu/Lucas) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
